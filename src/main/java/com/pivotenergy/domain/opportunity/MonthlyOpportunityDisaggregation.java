...
@Getter
@NoArgsConstructor
public class MonthlyOpportunityDisaggregation extends MultiTenantBaseEntity<MonthlyOpportunityDisaggregation> {
    @NotNull
    @Range(min = 1, max = 12)
     ...
     * @param opportunity the parent opportunity
     */
    public MonthlyOpportunityDisaggregation(Integer month,
