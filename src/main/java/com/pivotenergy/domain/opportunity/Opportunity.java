...
public class Opportunity extends MultiTenantBaseEntity<Opportunity> {

    // This is the building id as well
    ...
    private Set<MonthlyOpportunityDisaggregation> monthlyDisaggregation;
     ...
     */
    public Opportunity(String baselineId, String scenarioId, String name, String description,
                       Set<String> systemsRetrofitted,
                       Set<String> subSystemsRetrofitted,
                       Outcomes buildingOutcome,
                       ...
                       Set<MonthlyOpportunityDisaggregation> monthlyDisaggregation) {
    ...
    public Opportunity setMeasures(Set<Measure> measures) {
        this.measures = measures;
        return this;
    }

    public Opportunity setMonthlyDisaggregation(Set<MonthlyOpportunityDisaggregation> monthlyDisaggregation) {
        this.monthlyDisaggregation = monthlyDisaggregation;
        return this;
    }
}
